                    ...
                    <form action="<?= base_url('Surat_masuk/update'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="perihal_surat_masuk"
                                    name="perihal_surat_masuk"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="tipe_file_surat_masuk" name="tipe_file_surat_masuk"
                                required>
                                <option selected>Pilih Tipe File</option>
                                <option value="img"
                                    <?= $surat_masuk['tipe_file_surat_masuk'] == 'img' ? 'selected' : ''; ?>>IMG
                                </option>
                                <option value="pdf"
                                    <?= $surat_masuk['tipe_file_surat_masuk'] == 'pdf' ? 'selected' : ''; ?>>PDF
                                </option>
                            </select>
                        </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse bg-white"
                                    ...
                                    <div class="accordion-body bg-white">
                                        <div class="row mb-3">
                                            <div class="col-md-9">
                                                <label for="pegawai_disposisi" class="form-label">Pegawai
                                                    Disposisi</label>
    ...
    if (id_pegawai == 'Pilih Pegawai') {
        ...
        for (var i = 0; i < data_disposisi_pegawai.length; i++) {
            if (data_disposisi_pegawai[i].id_pegawai == id_pegawai) {
                sweetalert('warning', 'Pegawai sudah ada');
                return false;
            }
        }
        var data = {
...
$(document).on('click', '.hapus_disposisi', function() {
    ...
    // jika jumah pegawai kurng dari 2
    if (data_disposisi_pegawai.length == 1) {
        sweetalert('warning', 'Diposisi minimal 1 pegawai');
        return false;
    }
    for (var i = 0; i < data_disposisi_pegawai.length; i++) {
        if (data_disposisi_pegawai[i].id_pegawai == id_pegawai) {
