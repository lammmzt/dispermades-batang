...
class externalModel extends Model
{
    ...
    protected $allowedFields = ['id_external', 'id_user', 'nama_external', 'email_external', 'kota_external', 'alamat_external', 'status_external', 'no_tlp_external','created_at', 'updated_at'];
